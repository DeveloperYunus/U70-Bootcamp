...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		private const float _threshold = 0.0f;						// normalde burası 0.01f di -- Bu değer 0 olunca mobil UI daki look kısmının kameraya etkilemesi için gereken değeri kaldırı
		...
		private void JumpAndGravity()
		{
			if (Grounded)
			{
				...
				{
                    AudioManager.ins.PlaySound("jump");//yunus
